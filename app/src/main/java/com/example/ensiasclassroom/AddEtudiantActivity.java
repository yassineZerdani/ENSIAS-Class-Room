...
import com.example.ensiasclassroom.databinding.ActivityAddEtudiantBinding;
...
public class AddEtudiantActivity extends AppCompatActivity {
    ...
    private ActivityAddEtudiantBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAddEtudiantBinding.inflate(getLayoutInflater());
    ...
    private void addService(){
        ...
        service.put(Constants.KEY_ETUDIANT_IMAGE, encodedImage);
        service.put(Constants.KEY_ETUDIANT_FIRST_NAME, binding.nomProf.getText().toString());
        service.put(Constants.KEY_ETUDIANT_LAST_NAME, binding.prenomProf.getText().toString());
        service.put(Constants.KEY_ETUDIANT_EMAIL, binding.emailProf.getText().toString());
        service.put(Constants.KEY_ETUDIANT_PASSWORD, binding.passwordProf.getText().toString());
        database.collection(Constants.KEY_COLLECTION_ETUDIANT).add(service).addOnSuccessListener(documentReference -> {
