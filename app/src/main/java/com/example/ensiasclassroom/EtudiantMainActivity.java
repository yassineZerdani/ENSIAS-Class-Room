...
public class EtudiantMainActivity extends AppCompatActivity {
    ...
    private void setListeners(){
        ...
        binding.groups.setOnClickListener(v -> startActivity(new Intent(getApplicationContext(), AddGroupActivity.class)));
    }
    ...
    private void updateToken(String token){
        ...
        DocumentReference documentReference = database.collection(Constants.KEY_COLLECTION_ETUDIANT).document(
