...
public class ProfesseurChatActivity extends AppCompatActivity {
    ...
    private void sendMessage(){
        ...
        message.put(Constants.KEY_SENDER_ID, preferenceManager.getString(Constants.KEY_PROFESSOR_ID));
    ...
    private void listenMessages(){
        database.collection(Constants.KEY_COLLECTION_CHAT)
                .whereEqualTo(Constants.KEY_SENDER_ID, preferenceManager.getString(Constants.KEY_PROFESSOR_ID))
